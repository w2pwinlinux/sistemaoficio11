...
<HTML>
  ...
  <BODY >
    ...
    <input type="hidden" name="input_title" id="input_title" value="REPORTE MARCA">
    <!--<div id="header"></div>-->
    ...
    <div class="easyui-layout div_principal" style="width:100%;height:1000px;padding:10px;border: thin solid #E0ECFF;" >
      ...
      <div id="dlg_paso1" class="easyui-dialog"
        ...
        <table id="dg_PASO1" class="easyui-datagrid dg_PASO1" title="--"
          ...
          <thead>
            <tr>
              ...
              <th field="NOMBRE" width="40%" >Nombre</th>
              <th field="ESTADO" width="10%" >Estado</th>
              <th field="CREATED" width="10%"  >F.Creado</th>
              <th field="MODIFIED" width="10%"  >F.Modifica</th>
            </tr>
          </thead>
        </table>
        <!-- PARA TOOLBAR -->
        <div id="toolbar_PAC_REVISION">
          ...
          <div class="btn-container">Opciones
            <a href="javascript:void(0);" class="easyui-linkbutton icon-ok" onclick="q_open_nuevo()">Nuevo</a>
            <a href="javascript:void(0);" class="easyui-linkbutton icon-edit" onclick="q_open_dialog_edit()">Editar</a>
            <a href="javascript:void(0);" class="easyui-linkbutton icon-remove" onclick="q_edit_estado(0)">Desactivar</a>
            <a href="javascript:void(0);" class="easyui-linkbutton icon-ok" onclick="q_edit_estado(1)">Activar</a>
            <a href="home.php" class="easyui-linkbutton icon-cancel">Cerrar Módulo</a>
          </div>
          ...
          <div class="btn-container reportes">Reporte :
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick='generar_reportes("pdf","jquery/q_categoria1_jquery.php",99,$("#input_title").val(),4)'> PDF </a>
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick='generar_reportes("excel","jquery/q_categoria1_jquery.php",99,$("#input_title").val(),4)'> EXCEL </a>
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick='generar_reportes("html","jquery/q_categoria1_jquery.php",99,$("#input_title").val(),4)'> WEB </a> </div>
          </div>
        </div>
      </div>
      </div><!-- FIN PASO 1-->
    ...
    <script  language="javascript" src="js/q_categoria1_js.js?<?php echo r_v_2024(); ?>" ></script>
  </html>