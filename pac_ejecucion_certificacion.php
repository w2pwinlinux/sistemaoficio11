...
<HTML>
  ...
  <BODY >
    ID_CERTIFICACION: <input type="hidden" name="ID_CERTIFICACION" id="ID_CERTIFICACION" value="-1">
    ID_ESTADO_INTERNO: <input type="hidden" name="ID_ESTADO_INTERNO" id="ID_ESTADO_INTERNO" value="-1">
    ID_TIPO_SOLICITUD: <input type="hidden" name="ID_TIPO_SOLICITUD" id="ID_TIPO_SOLICITUD" value="BIEN">
    CATEGORIA: <input type="hidden" name="CATEGORIA" id="CATEGORIA" value="FACULTAD">
    ...
    <div class="easyui-layout div_principal" style="width:100%;height:1000px;padding:10px;border: thin solid #E0ECFF;" >
      ...
      <div id="dlg_paso1" class="easyui-dialog"
        ...
        <table id="dg_PASO1" class="easyui-datagrid dg_PASO1" title="--" data-options="
          ...
          <thead>
            <tr>
              <th field="ID" width="5%" formatter="fontsize8" >IDPAC</th>
              <th field="DATO_DEPENDENCIA" width="25%" formatter="fontsize8" >Dependencia</th>
              <!--<th field="DATO_PLANIFICACION" width="35%" formatter="fontsize8" >Datos Planificación</th>-->
              <th field="DATO_FINANCIERO_MIN" width="50%" formatter="detalleFormatter_bien" >Detalle</th>
              <!--<th field="DATO_EJE" width="10%" formatter="fontsize8" >EJE</th>-->
              
              <!--<th field="DATO_DISTRIBUCION" width="30%" formatter="dato_size_min" >Programa</th>-->
              
              <!--<th field="EJECUCION_ESTADO_REVISION" width="5%" formatter="fontsize8_estados_pac_proforma" >EstadoPAC</th>-->
              <th field="EJECUCION_ESTADO" width="20%" formatter="fontsize8_estados_pac_proforma" >Estado Ejecución</th>
      ...
      <div id="dlg_paso2" class="easyui-dialog"
        ...
        <table id="dg_PASO2" class="easyui-datagrid dg_PASO2" title="--" data-options="
          ...
          <thead>
            <tr>
              <th field="ID" width="5%" formatter="fontsize8" >ID</th>
              <th field="ID_PAC" width="5%" formatter="fontsize8" >IdPac</th>
              <th field="DATO_DEPENDENCIA" width="20%" formatter="fontsize8" >Dependencia</th>
              <th field="DATO_FINANCIERO_MIN" width="30%" formatter="fontsize8" >Bien/Servicio</th>
              <th field="CODIFICADO_CANTIDAD" width="5%" formatter="fontsize8" >Cantidad</th>
              <th field="SOLICITADO_CANTIDAD" width="5%" formatter="fontsize8" >Cant.Solicitada</th>
              
              <th field="CODIFICADO" width="10%" formatter="fontsize8" >VT</th>
              
              <th field="SOLICITADO" width="10%" formatter="fontsize8" >VT Solicitada</th>
              
              
              <!--<th field="OBSERVACION" width="10%" formatter="fontsize8" >Observación</th>-->
              <!--<th field="DATO_DISTRIBUCION" width="30%" formatter="dato_size_min" >Programa</th>-->
              
              <th field="ESTADO" width="5%" formatter="fontsize8_estados_pac_proforma" >Estado</th>
              <!--<th field="EJECUCION_ESTADO" width="20%" formatter="fontsize8_estados_pac_proforma" >Estado Ejecución</th>-->
