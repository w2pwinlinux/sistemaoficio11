    ...
    <div class="easyui-layout div_principal" style="width:100%;height:1000px;padding:10px;border: thin solid #E0ECFF;" >
      ...
      <div id="dlg_paso1" class="easyui-dialog"
        ...
        <table id="dg_PASO1" class="easyui-datagrid dg_PASO1" title="--"
          ...
          pageSize:50,pageList:[10,20,30,50,100],
          ...
          <thead>
            <tr>
              ...
              <th field="DATOS" width="25%" >Cliente</th>
              <th field="FECHA" width="10%" >Fecha Orden</th>
              <th field="DESPACHO" width="20%" >Despacho</th>
              <th field="ESTADO" width="10%" formatter="estado_color" >Estado</th>
        ...
        <div id="toolbar_PAC_REVISION">
          ...
          <div>
            ...
            <a href="javascript:void(0);" target="" class="easyui-linkbutton" iconCls="icon-ok" plain="true" onclick="q_finalizar_despacho_orden()" >Procesar Despacho</a>

          
            <a href="javascript:void(0);" target="" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="q_finalizar_despacho_orden_anular()" >Anular Orden</a>
            
            <a href="javascript:void(0);" target="" class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="q_orden_open_reporte()" > Reporte Individual</a>
          ...
          <div>Reporte :
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick='generar_reportes("pdf","jquery/q_orden_despacho1_jquery.php",99,$("#input_title").val(),6)'> PDF </a>
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick='generar_reportes("excel","jquery/q_orden_despacho1_jquery.php",99,$("#input_title").val(),6)'> EXCEL </a>
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick='generar_reportes("html","jquery/q_orden_despacho1_jquery.php",99,$("#input_title").val(),6)'> WEB </a> </div>
          </div>
        </div>
      </div>
      </div><!-- FIN PASO 1-->
        ...
        <form id="dlg_paso2_orden_detalle_add_form" class="easyui-form" method="post" novalidate enctype="multipart/form-data">
          ...
          <div class="modal-content2">
            ...
            <div class="form-row">
              <!-- Botones de acción -->
              <div class="form-group">
                <a href="javascript:void(0);" class="easyui-linkbutton btn-submit" iconCls="icon-ok" onclick="q_grabar_nuevo_orden_detalle()">Agregar a Detalle</a>
      ...
      <script  language="javascript" src="js/q_orden_despacho1_js.js?<?php echo r_v_2024(); ?>" ></script>
    </html>