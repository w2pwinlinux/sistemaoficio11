      ...
      <div id="dlg_paso1" class="easyui-dialog"
        ...
        <div id="toolbar_PAC_REVISION">
          ...
          <div class="btn-container reportes">Reporte :
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick='generar_reportes("pdf","jquery/q_coleccion1_jquery.php",99,$("#input_title").val(),7)'> PDF </a>
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick='generar_reportes("excel","jquery/q_coleccion1_jquery.php",99,$("#input_title").val(),7)'> EXCEL </a>
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick='generar_reportes("html","jquery/q_coleccion1_jquery.php",99,$("#input_title").val(),7)'> WEB </a> 
          </div>
