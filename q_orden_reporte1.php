    ...
    <div class="easyui-layout div_principal" style="width:100%;height:1000px;padding:10px;border: thin solid #E0ECFF;" >
      ...
      <div id="dlg_paso1" class="easyui-dialog"
        ...
        <div id="toolbar_PAC_REVISION">
          <div id="filtros">
            Fecha Inicial: <input id="FECHA_INICIAL" name="FECHA_INICIAL" class="easyui-datebox texto"  data-options="required:true, formatter:myformatter, parser:myparser">
            Fecha Final: <input id="FECHA_FINAL" name="FECHA_FINAL" class="easyui-datebox texto"  data-options="required:true, formatter:myformatter, parser:myparser">
          ...
          <div class="btn-container reportes">Reporte :
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick='generar_reportes_fechas("pdf","jquery/q_orden_reporte1_jquery.php",99,$("#input_title").val(),6,$("#FECHA_INICIAL").val(),$("#FECHA_FINAL").val())'> PDF </a>
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick='generar_reportes_fechas("excel","jquery/q_orden_reporte1_jquery.php",99,$("#input_title").val(),6,$("#FECHA_INICIAL").val(),$("#FECHA_FINAL").val())'> EXCEL </a>
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick='generar_reportes_fechas("html","jquery/q_orden_reporte1_jquery.php",99,$("#input_title").val(),6,$("#FECHA_INICIAL").val(),$("#FECHA_FINAL").val())'> WEB </a> </div>
          </div>
        </div>
      </div>
      </div><!-- FIN PASO 1-->
      ...
      <script  language="javascript" src="js/q_orden_reporte1_js.js?<?php echo r_v_2024(); ?>" ></script>
    </html>